...
chat = ""
normal_speed = True
sound = False # If you turn it to True, put your own sounds in the same folder an name them:
              # blob_explode.ogg, blob_lost.ogg, eat_blob.ogg, eat_dot.ogg, eat_smbh.ogg, eject.ogg, recombine.ogg 
              # Else the program will crash with this error:
              #
              # Traceback (most recent call last):
              # File "Agar.py", line ***, in <module>
              #    if sound: zelle_sound.play()
              # NameError: name 'zelle_sound' is not defined
ki = True
